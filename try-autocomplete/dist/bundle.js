...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderItems(items) {
	    ...
	    return items.map(function (item, index) {
	        ...
	        if (index === 0 || items[index - 1].props.children.charAt(0) !== text.charAt(0)) {
	            ...
	            return [React.createElement("div", {style: style}, text.charAt(0)), item];
	        }
	        else {
	            return item;
	        }
	...
	ReactDOM.render(React.createElement(Autocomplete, {initialValue: "", labelText: "test", inputProps: { name: "test" }, items: ['test', 'abc', 'abcdef', 'test123'], getItemValue: function (item) {
	    ...
	    return (React.createElement("div", {style: isHighlighted ? { color: 'red' } : { color: 'black' }, key: item}, item));
	}, renderMenu: function (items, value, style) {
	    console.log('renderMenu', items, value, style);
	    return (React.createElement("div", null, renderItems(items)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var scrollIntoView = __webpack_require__(7);
