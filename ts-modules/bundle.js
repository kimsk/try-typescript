...
exports.Test = exports.bar = undefined;
...
var _export = __webpack_require__(114);

var foobar = _interopRequireWildcard(_export);
...
console.log(foobar.default);
console.log(foobar.default.a);
console.log(_export.bar);
function test(str) {
    console.log(str);
}
test('1..');
var t = new foobar.Test();
t.test({ a: '10', b: 10 });
